...
public class NGramSimilarity {
    ...
    public boolean equals(Object obj) {
        ...
        NGramSimilarity o = (NGramSimilarity) obj;
        return o.n == this.n;
    }
    ...
    public boolean ifNgramSimilar(String source, String target){
        float similarity=getSimilarity(source.toLowerCase(), target.toLowerCase());
        return similarity>0.8;
    }
    public static void main(String args[]) {
        NGramSimilarity ng = new NGramSimilarity(3);
        float similarity=ng.getSimilarity(" how are you".toLowerCase(), "hello how are you".toLowerCase());
    }
}
